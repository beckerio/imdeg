...
hendrycks_full_names= {
    # Noise
    "gaussian_noise": "Gaussian Noise",
    "shot_noise": "Shot Noise", # somtimes (Photon Noise)
    "impulse_noise": "Impulse Noise", # (Salt-and-Pepper)
    ...
    "frost": "Frost",
    "snow": "Snow",
    "spatter": "Spatter", #(Droplets)

    # Brightness/Exposure
    "brightness": "Brightness",# (Exposure)

    # Sharpness/Contrast/Texture
    "contrast": "Contrast",
    ...
    # Compression
    "jpeg_compression": "JPEG", #JPEG Compression

    # Resolution/Sampling
    "pixelate": "Pixelation",

    # Geometry/Spatial
    "elastic_transform": "Elastic Transformation",
}

hendrycks_subset_common =['jpeg_compression',
                          'pixelate',
                          'elastic_transform',
                          'impulse_noise',
                          'glass_blur',
...
def get_corruption_subsets(subset='common'):
    if subset == 'common':
